...
%\fxnote{skb: removed the series from y-axis label. Should I remove the rest as well since it is already stated in the figure caption?}
\end{figure}
...
\begin{table}[tbp]
	\begin{center}
		...
		\begin{tabular}{l | D{.}{.}{3} @{\qquad} D{.}{.}{3} @{\qquad} D{.}{.}{3}  @{\qquad} | @{\qquad}
			...
			Estonians          & \multicolumn{1}{c}{1}      & \multicolumn{1}{l}{\hspace{12pt}2}      & \multicolumn{1}{l}{\hspace{12pt}3} & \multicolumn{1}{c}{1}      & \multicolumn{1}{l}{\hspace{12pt}2}      & \multicolumn{1}{c}{3}      \\\midrule
