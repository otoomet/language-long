...
We estimate three models that differ in terms of 
...
not have been closely associated with favorable unobserved
...
is close to zero and not statistically significant.  As in
...
wage premium, up to 34 log points, for all the analyzed groups.  The number falls substantially when introducing the
individual characteristics into the model (model 2), additional
workplace characteristics have less effect.  However, in all
specifications it remains
noticeably more
...
language most closely associated with income for men.  The effect of Russian is minor and
...
during the 1990s, it is instructive to analyze the effect long-term
...
two decades.  However, for women we can see that Estonian language turned
important in late 1990s, suggesting that there is either less
workplace segregation or other kind of necessity to know the official
language at 
...
women as well, but
since year 2000, we observe a sizable gain of approximately
...
In comparison, the estimates for English language trend downward over
time
for all age groups for both men and for women.  A likely
...
The fact the Russian language is not associated with any better
