...
\cite{Dietrich2005} discusses the status of the Russian language and the related language policy in former Soviet Union countries.
\cite{Giddings2003} discusses the ethnic wage gap in Bulgaria between ethnic Bulgarians and ethnic Turks. The wage gap increased from 0.16 in 1986 to 0.4 log points on average in 1997.
...
%\enquote{During the Soviet era, proficiency in the Russian language was often a ticket to
...
%	Soviet countries.} 
\fxnote{SKB: Quite detailed article about Russian language proficiency in three former Soviet Union states. Needs further comments from us and find similar articles.}
...
Still, they find confirmation of the results in \cite{Kahanec2009}, that a finding a job is difficult as a member of an ethnic minority. 
\cite{Constant2011} document the ethnic wage gap in Ukraine between ethnic  Russians and ethnic Ukrainians in favour of ethnic Russians.
%But after being in the job, the labour market prospect are somewhat similar to the ethnic majority members.
...
Even earlier, \cite{Kroncke1999} found for Estonian Labour Force Survey that in 1989, there was no evidence for ethnic wage discrimination in Estonia, while in 1994 there was already a substantial wage discrimination against ethnic Russians. But in line with our findings here and in \cite{Toomet2011}, Estonian language skills did not affects wages.  
...
\fxnote{ot: remove the cryptic series?}
e-adjustment, English skills become extremely
...
\fxwarning{SKB: Not found yet, otherwise drop it.}
...
\begin{sidewaystable}[tbp]
	...
	\caption*{\small
		...
		25-55 year old.\\
		\emph{RUS 0} refers to indiv
                                          iduals who cannot speak Russian and
		\emph{RUS 1} to those who can
                                          . ;Analogously for 
                                      
                 \end{flushleft English
                (ENG) and
		Estonian (EST).\\
...
<<<<<<< HEAD
ght have been interesting or useful, if it was done properly documented. But that might warrant another section or even another paper. See \cite{fabo+2017E} for more on that.
}
=======
, we find that ethnic segregation is more prevalent in the male
stonian
Concluding Remarks}
