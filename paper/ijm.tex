...
Estonian is related to approximately 5 percentage points lower
unemployment probability, but to virtually no income
...
\begin{sidewaystable}[tbp]
	...
	\label{tab:descriptive}%
        \newgeometry{textwidth=0.75\paperheight}
        \begin{flushleft}
...
\fxnote{ot: if you do random effects--do you still have to cluster?}
...
in Appendix).
\fxerror{ot: if we have wage, we should also have unemployment}
The
...
\begin{table}[h]
	\begin{center}
		\caption{Estimation results for unemployment probability.}
...
\begin{table}[tbp]
	\begin{center}
		...
		\end{tabular}
		\begin{flushleft}
                  \legend \\ Standard errors (clustered on individuals) in parenthesis \\ Individual characteristics are \modelTwo. \\ Workplace characteristics are \modelThreeAdd. \\ \restrictions
		\end{flushleft}
	\end{center}
\end{table}
...
\begin{figure}[bt!]
	...
	\caption{The effect of language fluency on unemployment probability, 1992--2012. \\ Control variables are \modelTwo. \agerestrictions }
