...
\item- The description of the estimation models in Chapter 4 should
  ...
  \fxwarning{SKB: What do you mean? As far as I understand clustered standard errors, they introduce a random effect into the estimation, but should not be completely equivalent in our case, because we do not have a typical panel structure.}
...
\item In the paper, you are only showing the results of the variables of
  ...
  \begin{response}
    ...
    \fxerror{skb: now both are available}
  \end{response}
