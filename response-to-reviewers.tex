...
\usepackage{isomath} %SKB: Changed from \input{isomath} to \usepackage{isomath}
\newcommand{\skb}[1]{
	\begin{quotation}
		\color{Blue} SKB: #1	
	\end{quotation}
...
\item 
  ...
  \debug{SKB: I did the estimation separated by regions, but not 
  separated by regions and educational level. We could add the regional
  breakdown in the appendix or add it as another extension to chapter 6.}
...
\item- The description of the estimation models in Chapter 4 should
  ...
  \debug{SKB: Svetlana modified the equations a bit. I added another table,
  which summarises the models.}
\item - The tables and figures should have notes that explain in more
  ...
  \debug{SKB: I added this information to the tables and the figures. The descriptions might need some polishing still.}
\item 
...
\debug{SKB: Fixed. Changed obs to observations}
\item
...
I made new folder in dropbox:Tabels4_5. Here are Estimates for the age groups for 4 sub-periods, for time period 2000-2012 and for time period 1989-2012. I also made some changes in the text.}
